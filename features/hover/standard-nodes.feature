Feature: Standard Top-Level Node Hover Documentation
  ...
  Scenario: Hover on the root node shows root node documentation
    Given a devicetree with a root node
    When hovering over the root node declaration
    Then the hover returns the contents of the "Root node" section from the devicetree specification

  Scenario: Hover on "serial-number" on the root node
    Given a root node with serial-number
    When hovering over "serial-number" on the root node
    Then the hover returns the definition of "serial-number" from the "Root node" section of the devicetree specification

  Scenario: Hover on "chassis-type" on the root node
  ...
  Scenario: Hover on "/aliases" shows aliases node documentation
  ...
  Scenario: Hover on "/memory" shows memory node documentation
  ...
  Scenario: Hover on "initial-mapped-area" on a memory node
  ...
  Scenario: Hover on "hotpluggable" on a memory node
  ...
  Scenario: Hover on "/reserved-memory" shows reserved memory documentation
  ...
  Scenario: Hover on "size" on a reserved-memory child node
  ...
  Scenario: Hover on "alignment" on a reserved-memory child node
  ...
  Scenario: Hover on "alloc-ranges" on a reserved-memory child node
  ...
  Scenario: Hover on "no-map" on a reserved-memory child node
  ...
  Scenario: Hover on "reusable" on a reserved-memory child node
  ...
  Scenario: Hover on "memory-region" on a device node
  ...
  Scenario: Hover on "memory-region-names" on a device node
  ...
  Scenario: Hover on "/chosen" shows chosen node documentation
  ...
  Scenario: Hover on "bootargs" on the chosen node
  ...
  Scenario: Hover on "bootsource" on the chosen node
  ...
  Scenario: Hover on "stdout-path" on the chosen node
  ...
  Scenario: Hover on "stdin-path" on the chosen node
  ...
  Scenario: Hover on "/cpus" shows cpus container node documentation
  ...
  Scenario: Hover on a "/cpus/cpu*" node shows CPU node documentation
  ...
  Scenario: Hover on "clock-frequency" on a cpu node
  ...
  Scenario: Hover on "timebase-frequency" on a cpu node
  ...
  Scenario: Hover on "enable-method" on a cpu node
  ...
  Scenario: Hover on "cpu-release-addr" on a cpu node
  ...
  Scenario: Hover on "power-isa-version" on a cpu node
  ...
  Scenario: Hover on a "power-isa-*" category property on a cpu node
  ...
  Scenario: Hover on "cache-op-block-size" on a cpu node
  ...
  Scenario: Hover on "reservation-granule-size" on a cpu node
  ...
  Scenario: Hover on "mmu-type" on a cpu node
  ...
  Scenario: Hover on "tlb-split" on a cpu node
  ...
  Scenario: Hover on "tlb-size" on a cpu node
  ...
  Scenario: Hover on "tlb-sets" on a cpu node
  ...
  Scenario: Hover on "d-tlb-size" on a cpu node
  ...
  Scenario: Hover on "d-tlb-sets" on a cpu node
  ...
  Scenario: Hover on "i-tlb-size" on a cpu node
  ...
  Scenario: Hover on "i-tlb-sets" on a cpu node
  ...
  Scenario: Hover on "cache-unified" on a cpu node
  ...
  Scenario: Hover on "cache-size" on a cpu node
  ...
  Scenario: Hover on "cache-sets" on a cpu node
  ...
  Scenario: Hover on "cache-block-size" on a cpu node
  ...
  Scenario: Hover on "cache-line-size" on a cpu node
  ...
  Scenario: Hover on "i-cache-size" on a cpu node
  ...
  Scenario: Hover on "i-cache-sets" on a cpu node
  ...
  Scenario: Hover on "i-cache-block-size" on a cpu node
  ...
  Scenario: Hover on "i-cache-line-size" on a cpu node
  ...
  Scenario: Hover on "d-cache-size" on a cpu node
  ...
  Scenario: Hover on "d-cache-sets" on a cpu node
  ...
  Scenario: Hover on "d-cache-block-size" on a cpu node
  ...
  Scenario: Hover on "d-cache-line-size" on a cpu node
  ...
  Scenario: Hover on "next-level-cache" on a cpu node
  ...
  Scenario: Hover on a cache node shows cache node documentation
  ...
  Scenario: Hover on "cache-level" on a cache node
