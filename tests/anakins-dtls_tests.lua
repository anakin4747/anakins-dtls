...
describe("hover()", function()
    ...
    describe("interrupt and nexus properties", function()
        it("returns hover markdown for `interrupts` property name", function()
            ctx.row, ctx.col = row_col("tests/custom.dts:359:9")
            local expected = dtls.dedent([[
                # Devicetree Specification:
        ...
        it("returns hover markdown for `interrupt-parent` property name", function()
            ctx.row, ctx.col = row_col("tests/custom.dts:360:9")
            local expected = dtls.dedent([[
                # Devicetree Specification:
        ...
        it("returns hover markdown for `interrupts-extended` property name", function()
            ...
            ]]) .. dtls.get_type_definition("phandle") .. dtls.get_type_definition("prop_encoded_array")
            local actual = dtls.hover(ctx)
            assert.are.same(expected, actual)
        end)

        it("returns hover markdown for `#interrupt-cells` property name", function()
            ctx.row, ctx.col = row_col("tests/custom.dts:363:9")
            local expected = dtls.dedent([[
                # Devicetree Specification:
        ...
        it("returns hover markdown for `interrupt-controller` property name", function()
            ctx.row, ctx.col = row_col("tests/custom.dts:362:9")
            local expected = dtls.dedent([[
                # Devicetree Specification:
        ...
        it("returns hover markdown for `interrupt-map` property name", function()
            ctx.row, ctx.col = row_col("tests/custom.dts:396:9")
            local expected = dtls.dedent([[
                # Devicetree Specification:
        ...
        it("returns hover markdown for `interrupt-map-mask` property name", function()
            ctx.row, ctx.col = row_col("tests/custom.dts:397:9")
            local expected = dtls.dedent([[
                # Devicetree Specification:
        ...
        describe("Nexus Node Properties", function()
            ...
            it("returns hover markdown for `#widget-cells` property name", function()
                ctx.file = nexus_file
                ctx.row, ctx.col = row_col("tests/nexus-node-properties.dts:5:9")
                local expected = dtls.dedent([[
                    # Devicetree Specification:
            ...
            it("returns hover markdown for `widget-map` property name", function()
                ctx.file = nexus_file
                ctx.row, ctx.col = row_col("tests/nexus-node-properties.dts:6:9")
                local expected = dtls.dedent([[
                    # Devicetree Specification:
            ...
            it("returns hover markdown for `widget-map-mask` property name", function()
                ctx.file = nexus_file
                ctx.row, ctx.col = row_col("tests/nexus-node-properties.dts:7:9")
                local expected = dtls.dedent([[
                    # Devicetree Specification:
            ...
            it("returns hover markdown for `widget-map-pass-thru` property name", function()
                ctx.file = nexus_file
                ctx.row, ctx.col = row_col("tests/nexus-node-properties.dts:8:9")
                local expected = dtls.dedent([[
                    # Devicetree Specification:
            ...
            it("returns hover markdown for `#signal-cells` property name", function()
                ctx.file = nexus_file
                ctx.row, ctx.col = row_col("tests/nexus-node-properties.dts:12:9")
                local expected = dtls.dedent([[
                    # Devicetree Specification:
            ...
            it("returns hover markdown for `signal-map` property name", function()
                ctx.file = nexus_file
                ctx.row, ctx.col = row_col("tests/nexus-node-properties.dts:13:9")
                local expected = dtls.dedent([[
                    # Devicetree Specification:
            ...
            it("returns hover markdown for `signal-map-mask` property name", function()
                ctx.file = nexus_file
                ctx.row, ctx.col = row_col("tests/nexus-node-properties.dts:14:9")
                local expected = dtls.dedent([[
                    # Devicetree Specification:
            ...
            it("returns hover markdown for `signal-map-pass-thru` property name", function()
                ctx.file = nexus_file
                ctx.row, ctx.col = row_col("tests/nexus-node-properties.dts:15:9")
                local expected = dtls.dedent([[
                    # Devicetree Specification:
            ...
            for _, location in ipairs(excluded_specifier_properties) do
                it(("does not return Nexus Node Property hover markdown at %s"):format(location), function()
                    ctx.file = nexus_file
                    ctx.row, ctx.col = row_col(location)
