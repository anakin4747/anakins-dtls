...
TABLE_ROW_DOCS: dict[str, str] = {
    ...
    "ns16550:reg": "ns16550 UART Properties",
    "ns16550:interrupts": "ns16550 UART Properties",
    ...
    "open-pic:reg": "Open-PIC properties",
    ...
    "simple-bus:compatible": "``simple-bus`` Compatible Node Properties",
...
TABLE_ROW_DOC_SOURCES: dict[str, str] = {
    "reserved-memory:#address-cells": "/reserved-memory node",
    "reserved-memory:#size-cells": "/reserved-memory node",
    "reserved-memory:ranges": "/reserved-memory node",
    "reserved-memory:reg": "/reserved-memory/ child nodes",
    "reserved-memory:compatible": "/reserved-memory/ child nodes",
    "cpus:#address-cells": "/cpus node",
    "cpus:#size-cells": "/cpus node",
    "cpu:device_type": "/cpus/cpu* nodes",
    "cpu:reg": "/cpus/cpu* nodes",
    ...
    "simple-bus:compatible": "simple-bus",
...
DTS_FOCUSED_DOCS = {
    ...
    "dts:include-directive": (
        "## /include/ - DTS source language\n\n"
        "Other source files can be included from a DTS file. The name of "
        "include files should end with \".dtsi\". Included files can in turn "
        "include additional files.\n\n"
        "```\n/include/ \"FILE\"\n```"
    ),
    "dts:memory-reservation": (
    ...
    "dts:label-definition": (
        ...
        "only of the characters `0-9`, `a-z`, `A-Z`, and `_`, and must not "
        "start with a number."
    ),
    "dts:label-reference": (
        "## Label reference - DTS source language\n\n"
        "Phandle and path references can be automatically generated by "
        "referencing a label instead of explicitly specifying a phandle value "
        "or the full path to a node.\n\n"
    ...
    "dts:bytestring": (
        ...
        "represented by two hexadecimal digits. Spaces between each byte are optional.\n\n"
